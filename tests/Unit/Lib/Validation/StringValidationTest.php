...
final class StringValidationTest extends TestCase
{
    ...
    /**
     * Assert isNorwegianPhone throws IllegalValueException when supplied an
     * invalid phone number value.
     *
     * @return void
     * @throws IllegalValueException
     */
    public function testIsNorwegianPhoneThrowsInIllegal(): void
    {
        $this->expectException(exception: IllegalValueException::class);
        $this->stringValidation->isNorwegianPhone(value: '8000007');
    }

    /**
     * Assert isNorwegianPhone returns TRUE for properly formatted phone number.
     *
     * @return void
     * @throws IllegalValueException
     */
    public function testIsNorwegianPhone(): void
    {
        $this->assertTrue(
            condition: $this->stringValidation->isNorwegianPhone(value: '40000007')
        );
    }

    /**
     * Assert isNorwegianPhone returns TRUE when prefixed with 0047
     *
     * @return void
     * @throws IllegalValueException
     */
    public function testIsNorwegianPhoneAccepts0047(): void
    {
        $this->assertTrue(
            condition: $this->stringValidation->isNorwegianPhone(value: '004740000007')
        );
    }

    /**
     * Assert isNorwegianPhone returns TRUE when prefixed with +47
     *
     * @return void
     * @throws IllegalValueException
     */
    public function testIsNorwegianPhoneAcceptsPlus47(): void
    {
        $this->assertTrue(
            condition: $this->stringValidation->isNorwegianPhone(value: '+4740000007')
        );
    }
     ...
     * @throws IllegalValueException
     */
    public function testIsNorwegianPhoneThrowsOnAlpha(): void
    {
        $this->expectException(exception: IllegalValueException::class);
        $this->stringValidation->isNorwegianPhone(value: '1669973a8573');
    }
}
