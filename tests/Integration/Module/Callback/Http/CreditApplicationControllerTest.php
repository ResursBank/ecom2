...
use Resursbank\Ecom\Module\Callback\Http\CreditApplicationController as Controller;
use Resursbank\EcomTest\Data\Models\Instrument;

/**
 * Tests for credit application callbacks.
 */
...
class CreditApplicationControllerTest extends TestCase
{
     ...
     * supplied that does not convert to a CreditApplication instance.
     *
    ...
    {
        $applicationId = '6fa85f64-5997-45c2-b3fc-2c263f66afa6';
