...
/**
 * Webhook model for when the end user has made a shipping selection.
 */
class Shipping extends WebhookModel
{
    /**
     * @param string $url Posted to when the end user has made a shipping selection.
     */
